...
public class Graphe_cout {
     ...
     */
    public Graphe_cout(Integer type, Integer nbSommets, Integer nbConnexion){
        this.type = type;
     ...
     * @param nbSommets Integer
     */
    public Graphe_cout(Integer type, Integer nbSommets) {
        this.type = type;
        this.nbSommets = nbSommets;
        this.nbConnexion = 0;
        this.listeSuccesseurs = new ArrayList<>();
     ...
     * @param nbSommets Integer
     */
    public Graphe_cout(Integer type) {
        this.type = type;
        this.nbConnexion = 0;
        this.listeSuccesseurs = new ArrayList<>();
        this.random = new Random();
